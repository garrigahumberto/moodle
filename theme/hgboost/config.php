...
/**
 * The configuration for Hgboost theme is defined here.
 *
...
$THEME->scss = function($theme) {
    return theme_hgboost_get_main_scss_content($theme);
};
